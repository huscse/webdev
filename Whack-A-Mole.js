    ...
    if(!isPaused){
        let interval = setInterval(() => {
            ...
            if(document.getElementById("actualTimer")){
                document.getElementById("actualTimer").innerHTML = `${parseInt((totalGameTime+1)-elapsed.toFixed(1))}`;
            }
...
function MoleClickedGood(molee){
    ...
    document.getElementById("ActualScore").innerHTML = Number(document.getElementById("ActualScore").innerHTML)+10;
}
function MoleClickedMedium(){
    ...
    document.getElementById("ActualScore").innerHTML = Number(document.getElementById("ActualScore").innerHTML)+5;
}
function MoleMissed(){
